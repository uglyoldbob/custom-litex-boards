...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=100e6, 
        ...
        if with_video_terminal:
            self.hdmiphy = VideoHDMIPHY(platform.request("hdmi"), clock_domain="hdmi")
            self.add_video_terminal(phy=self.hdmiphy, timings="1280x720@60Hz", clock_domain="hdmi")
...
def main():
    ...
    parser.add_target_argument("--with-video-terminal", action="store_true", help="Enable hdmi video terminal")
