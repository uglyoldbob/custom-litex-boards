...
_io = [
    ...
    ("seven_segment",
        Subsignal("segments", Pins("R11 R12 P10 M12 M11 P11 P12 T12"), IOStandard("LVCMOS33")),
        Subsignal("digits_n", Pins("T13 U13 U12 T14 U14"), IOStandard("LVCMOS33")),
    ),
    ("hdmi",
        Subsignal("hpd", Pins("G7"), IOStandard("LVCMOS33")),
        Subsignal("scl", Pins("D5"), IOStandard("LVCMOS33")),
        Subsignal("sda", Pins("D17"), IOStandard("LVCMOS33")),
        Subsignal("cec", Pins("G6"), IOStandard("LVCMOS33")),
    ...
    ("jtag",
        ...
        Subsignal("trst_n", Pins("E14"), IOStandard("LVCMOS33")),
    ),
    ...
    ("pcie", 0,
        ...
        Subsignal("clk_p", Pins("A8"), IOStandard("LVCMOS33")),
        Subsignal("clk_n", Pins("B8"), IOStandard("LVCMOS33")),
        Subsignal("wake_n", Pins("C13"), IOStandard("LVCMOS33")),
        ...
        Subsignal("smbus_clk", Pins("E10"), IOStandard("LVCMOS33")),
        Subsignal("smbus_data", Pins("F10"), IOStandard("LVCMOS33")),
    ...
    ("i2s_main", 0,
        Subsignal("mclk", Pins("H13"), IOStandard("LVCMOS33")),
        Subsignal("sclk", Pins("H14"), IOStandard("LVCMOS33")),
    ),
    ("i2s_quad", 0,
        Subsignal("ws", Pins("J13"), IOStandard("LVCMOS33")),
        Subsignal("rx", Pins("H11 H12 J11 J10"), IOStandard("LVCMOS33")),
    ),
    ("i2s_quad", 1,
        Subsignal("ws", Pins("J12"), IOStandard("LVCMOS33")),
        Subsignal("rx", Pins("J15 J14 J17 J16"), IOStandard("LVCMOS33")),
    ),
    ("i2s_quad", 2,
        Subsignal("ws", Pins("K16"), IOStandard("LVCMOS33")),
        Subsignal("rx", Pins("K11 K10 L11 L10"), IOStandard("LVCMOS33")),
    ),
