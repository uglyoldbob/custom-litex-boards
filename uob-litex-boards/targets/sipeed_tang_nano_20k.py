    ...
    def __init__(self, core, platform, sys_clk_freq):
        ...
        self.comb += Case(self.vid_select.storage, {
                ...
                1: [self.vin.ready.eq(self.vout.ready),
                    ...
                    self.vout.vsync.eq(self.vin.vsync),
                    self.vout.de.eq(self.vin.de),
                    self.fifo.fifo.din.eq(hdmi_data),
                    self.fifo.fifo.we.eq(hdmi_data_valid),
                    self.fifo.fifo.re.eq(self.vout.ready),
                    self.vout.r.eq(self.fifo.fifo.dout[0:8]), 
                    self.vout.g.eq(self.fifo.fifo.dout[8:8]), 
                    self.vout.b.eq(self.fifo.fifo.dout[16:8])],
                2: [self.vin.ready.eq(self.vout.ready),
                    self.vout.hsync.eq(self.vin.hsync),
                    self.vout.vsync.eq(self.vin.vsync),
                    self.vout.de.eq(self.vin.de),
                    self.vout.r.eq(vidtest.o[0:8]), 
                    self.vout.g.eq(vidtest.o[8:8]), 
                    self.vout.b.eq(vidtest.o[16:8])],
                3: [self.vin.ready.eq(self.vout.ready),
                    ...
                    self.vout.g.eq(hdmi_data[8:8]), 
                    self.vout.b.eq(hdmi_data[16:8])],
